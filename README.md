...
Relational Databases are databases where information is stored, accesses and/or updated. SQL is a query langauge used to access informatin stored in the relational database

- [x] Why do tables need a `primary key`?

Tables need a primary key because there are unique indentifiers that are assigned to that peice of data/information that is being used. 
...
In order to have a many to many relationship, a bridge/common table that holds the foreign keys which link to the primary key from other tables
